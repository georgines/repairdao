...
export function criarRepairTokenGateway(contractClient: RepairDAOContractClient, rede?: RedeBlockchain) {
  return criarGatewayContrato(contractClient, obterRepairDAOContractos(rede).token);
}
