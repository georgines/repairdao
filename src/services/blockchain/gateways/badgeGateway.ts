...
export function criarRepairBadgeGateway(contractClient: RepairDAOContractClient, rede?: RedeBlockchain) {
  return criarGatewayContrato(contractClient, obterRepairDAOContractos(rede).badge);
}
