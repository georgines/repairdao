...
import { mapearDisputaDoContrato, mapearOrdemDoContrato, type DisputaContratoBruta, type DisputaContratoDominio, type OrdemContratoBruta, type OrdemContratoDominio } from "@/services/blockchain/adapters";
