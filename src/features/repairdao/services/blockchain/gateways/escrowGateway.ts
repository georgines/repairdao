...
import { criarGatewayContrato, normalizarEndereco, normalizarNumero, normalizarTextoOpcional, obterTextoDeContrato, obterValorDeContrato, garantirEscritaDisponivel, type GatewayContratoBase } from "@/features/repairdao/services/blockchain/gateways/shared";
