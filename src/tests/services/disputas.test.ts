...
describe("disputas", () => {
  ...
  it("bloqueia voto para parte envolvida, ja votante e sem tokens", () => {
    ...
    expect(garantirPodeReceberVoto(new Date("2026-04-01T10:00:00Z"), new Date("2026-04-01T11:00:00Z"), 1, false, false)).toBe(true);
    ...
    expect(() => garantirPodeReceberVoto(new Date("2026-04-01T10:00:00Z"), new Date("2026-04-01T11:00:00Z"), 1, false, true)).toThrow(/nao e permitido/);
  });
  ...
  it("respeita transicoes validas e calculo de slash", () => {
    ...
    expect(disputaPodeSerResolvida("aberta", new Date("2026-04-02T10:00:00Z"), new Date("2026-04-01T10:00:00Z"))).toBe(false);
    ...
    expect(() => calcularSlashDoPerdedor(0)).toThrow(/maior que zero/);
  });
});
