...
import type { DisputesPanelViewState } from "@/components/disputes/DisputesPanel/DisputesPanel.types";
import { DisputesPanelView } from "@/components/disputes/DisputesPanel/DisputesPanelView";

export function DisputesPanel() {
	const panel = useDisputesPanel();
	const viewState: DisputesPanelViewState = {
		header: {
	...
	return <DisputesPanelView {...viewState} />;
}
